...
function AvatarDialog({ open, onOpenChange, profile, avatar, onSaved }: { open: boolean; onOpenChange(open: boolean): void; profile: AccountProfile; avatar?: string; onSaved(): void }) {
  ...
  return <Dialog open={open} onOpenChange={onOpenChange}><DialogContent className="max-w-sm overflow-x-hidden"><DialogHeader><DialogTitle>Profil fotoğrafını değiştir</DialogTitle><DialogDescription>Profil fotoğrafınızı seçebilir veya mevcut fotoğrafınızı kaldırabilirsiniz.</DialogDescription></DialogHeader>
