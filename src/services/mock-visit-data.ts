...
const initialMockMeetingVisits: SeededMeetingVisit[] = [
  ...
  toVisit({ id: "v-123", firstName: "Yusuf", lastName: "Kaya", email: "yusuf.kaya@example.com", day: today, startHour: 13, durationHours: 2, typeId: "technical-service", employeeId: "emre-yilmaz", companyId: "bplas", facilityId: "bplas-arge", status: "PLANNED" }),
  toVisit({ id: "v-124", firstName: "Melis", lastName: "Tunc", email: "melis.tunc@example.com", day: addDays(today, 1), startHour: 9, durationHours: 1, typeId: "customer", employeeId: "selin-aydin", companyId: "bplas-otomotiv", facilityId: "otomotiv-uretim", status: "PLANNED" }),
  ...
  toVisit({ id: "v-126", firstName: "Nisa", lastName: "Guler", email: "nisa.guler@example.com", day: addDays(today, 3), startHour: 10, startMinute: 30, durationHours: 1, typeId: "supplier", employeeId: "emre-yilmaz", companyId: "bplas", facilityId: "bplas-arge", status: "PLANNED" }),
  ...
  toVisit({ id: "v-145", firstName: "Sinem", lastName: "Aras", email: "sinem.aras@example.com", day: today, startHour: 11, durationHours: 1, actualCheckIn: at(today, 11, 10), actualCheckOut: at(today, 11, 50), visitorCardReturned: true, typeId: "interview", employeeId: "maya-kara", companyId: "bplas", facilityId: "bplas-merkez", status: "CHECKED_OUT" }),
  toVisit({ id: "v-146", firstName: "Fırat", lastName: "Erdem", email: "firat.erdem@example.com", day: today, startHour: 13, startMinute: 30, durationHours: 1.5, typeId: "technical-service", employeeId: "emre-yilmaz", companyId: "bplas", facilityId: "bplas-arge", status: "PLANNED", note: "Test cihazı kalibrasyonu" }),
  ...
  toVisit({ id: "v-148", firstName: "Koray", lastName: "Deniz", email: "koray.deniz@example.com", day: today, startHour: 16, startMinute: 30, durationHours: 1, typeId: "supplier", employeeId: "emre-yilmaz", companyId: "bplas", facilityId: "bplas-arge", status: "PLANNED" }),
  toVisit({ id: "v-149", firstName: "Buse", lastName: "Akın", email: "buse.akin@example.com", day: today, startHour: 18, durationHours: 1, typeId: "training", employeeId: "maya-kara", companyId: "bplas", facilityId: "bplas-merkez", status: "PLANNED", note: "Gece vardiyası eğitim oturumu" }),
  ...
  toVisit({ id: "v-151", firstName: "Nehir", lastName: "Köse", email: "nehir.kose@example.com", day: addDays(today, 1), startHour: 10, durationHours: 2, typeId: "technical-service", employeeId: "emre-yilmaz", companyId: "bplas", facilityId: "bplas-arge", status: "PLANNED" }),
  toVisit({ id: "v-152", firstName: "Arda", lastName: "Gültekin", email: "arda.gultekin@example.com", day: addDays(today, 2), startHour: 11, durationHours: 1, typeId: "audit", employeeId: "selin-aydin", companyId: "bplas-otomotiv", facilityId: "otomotiv-uretim", status: "PLANNED" }),
  toVisit({ id: "v-153", firstName: "Mina", lastName: "Kaya", email: "mina.kaya@example.com", day: addDays(today, 3), startHour: 9, startMinute: 30, durationHours: 1, typeId: "customer", employeeId: "kerem-demir", companyId: "anadolu-lojistik", facilityId: "anadolu-lojistik-merkez", status: "PLANNED" }),
  toVisit({ id: "v-154", firstName: "Çağrı", lastName: "Kurt", email: "cagri.kurt@example.com", day: addDays(today, 4), startHour: 14, durationHours: 1.5, typeId: "supplier", employeeId: "maya-kara", companyId: "bplas", facilityId: "bplas-merkez", status: "PLANNED" }),
  toVisit({ id: "v-155", firstName: "Ceren", lastName: "Özer", email: "ceren.ozer@example.com", day: addDays(today, 5), startHour: 10, durationHours: 1, typeId: "interview", employeeId: "emre-yilmaz", companyId: "bplas", facilityId: "bplas-arge", status: "PLANNED" }),
  ...
  toVisit({ id: "v-157", firstName: "Dora", lastName: "Kara", email: "dora.kara@example.com", day: subDays(today, 2), startHour: 10, durationHours: 1, typeId: "interview", employeeId: "maya-kara", companyId: "bplas", facilityId: "bplas-merkez", status: "NO_SHOW" }),
  toVisit({ id: "v-158", firstName: "Kuzey", lastName: "Yalçın", email: "kuzey.yalcin@example.com", day: subDays(today, 3), startHour: 11, durationHours: 1.5, actualCheckIn: at(subDays(today, 3), 11, 6), actualCheckOut: at(subDays(today, 3), 12, 20), visitorCardReturned: true, typeId: "supplier", employeeId: "emre-yilmaz", companyId: "bplas", facilityId: "bplas-arge", status: "CHECKED_OUT" }),
  // --- Lifecycle demo seed rows -------------------------------------------
  // LC-1: Active, started, not yet overtime  → lifecycle actions visible
  toVisit({ id: "v-lc1", creatorEmployeeId: "maya-kara", firstName: "Emir", lastName: "Toprak", email: "emir.toprak@example.com", day: today, startHour: 8, startMinute: 0, durationHours: 10, actualCheckIn: at(today, 8, 3), typeId: "meeting", employeeId: "atahan-bora-bozkurt", companyId: "bplas", facilityId: "bplas-merkez", status: "CHECKED_IN" }),
  // LC-2: Active, overtime  → lifecycle actions visible + overtime label
  toVisit({ id: "v-lc2", creatorEmployeeId: "maya-kara", firstName: "Fikret", lastName: "Uzun", email: "fikret.uzun@example.com", day: subDays(today, 0), startHour: 0, startMinute: 0, durationHours: 1, actualCheckIn: at(today, 0, 5), typeId: "audit", employeeId: "atahan-bora-bozkurt", companyId: "bplas", facilityId: "bplas-arge", status: "CHECKED_IN", note: "Bitiş saati geçmiş toplantı demo" }),
  // LC-3: Closed manually  → read-only, shows variance (early)
  toVisit({ id: "v-lc3", firstName: "Gonca", lastName: "Demir", email: "gonca.demir@example.com", day: subDays(today, 0), startHour: 7, startMinute: 0, durationHours: 2, actualCheckIn: at(today, 7, 2), actualCheckOut: at(today, 8, 30), visitorCardReturned: true, typeId: "meeting", employeeId: "maya-kara", companyId: "bplas", facilityId: "bplas-merkez", status: "CHECKED_OUT", actualMeetingEnd: at(today, 8, 30), meetingEndSource: "MANUAL" }),
  // LC-4: Closed by last visitor checkout  → read-only, shows auto-close source
  toVisit({ id: "v-lc4", firstName: "Hande", lastName: "Kara", email: "hande.kara@example.com", day: subDays(today, 1), startHour: 14, startMinute: 0, durationHours: 1, actualCheckIn: at(subDays(today, 1), 14, 5), actualCheckOut: at(subDays(today, 1), 15, 22), visitorCardReturned: true, typeId: "customer", employeeId: "selin-aydin", companyId: "bplas-otomotiv", facilityId: "otomotiv-uretim", status: "CHECKED_OUT", actualMeetingEnd: at(subDays(today, 1), 15, 22), meetingEndSource: "VISITOR_CHECK_OUT" }),
]
