...
export const initialMockVisits: Visit[] = [
  ...
  toVisit({ id: "v-120", firstName: "Ayca", lastName: "Korkmaz", email: "ayca.korkmaz@example.com", day: today, startHour: 8, startMinute: 30, durationHours: 1, typeId: "meeting", employeeId: "maya-kara", companyId: "bplas", facilityId: "bplas-merkez", status: "PLANNED" }),
